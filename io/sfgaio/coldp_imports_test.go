...
func TestInsertDistributions(t *testing.T) {
	...
	err := sf.InsertDistributions(distr)
	assert.Nil(err)
	db := sf.Db()
	assert.NotNil(db)
...
func TestInsertNameRelations(t *testing.T) {
	...
	err = sf.InsertNameRelations(rel)
	assert.Nil(err)
	assert.NotNil(db)
...
func TestInsertSpeciesEstimate(t *testing.T) {
	...
	err := sf.InsertSpeciesEstimates(se)
	assert.Nil(err)
	db := sf.Db()
	assert.NotNil(db)
...
func TestInsertSpeciesInteractions(t *testing.T) {
	...
	err := sf.InsertSpeciesInteractions(si)
	assert.Nil(err)
	db := sf.Db()
	assert.NotNil(db)
...
func TestInsertTxConcRelations(t *testing.T) {
	...
	err := sf.InsertTaxonConceptRelations(tcr)
	assert.Nil(err)
	db := sf.Db()
	assert.NotNil(db)
...
func TestInsertTxProperties(t *testing.T) {
	...
	err := sf.InsertTaxonProperties(tp)
	assert.Nil(err)
	db := sf.Db()
	assert.NotNil(db)
